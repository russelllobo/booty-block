...
import { HIDDEN_ONBOARDING_STEPS, ONBOARDING_STEP_TOTAL } from '../../lib/onboardingSteps';
...
export default function OnboardingWelcome() {
  ...
  useOnboardingStepAnalytics(
    posthog,
    '/onboarding/welcome',
    HIDDEN_ONBOARDING_STEPS.welcome.key,
    HIDDEN_ONBOARDING_STEPS.welcome.title,
    HIDDEN_ONBOARDING_STEPS.welcome.index,
